...
const AddDoctor = () => {
    ...
    const handleAddDoctor = e => {
        fetch('https://infinite-castle-70516.herokuapp.com/doctors', {
            method: 'POST',
            headers: {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleAddDoctor}>
                ...
                <TextField onBlur={handleFieldValue} sx={{ width: '50%', m: 1 }} type="text" name="price" id="price" label="doctor Price" variant="standard" /> <br />
